...
# The base manifests/awscli2.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/awscli2.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
